...
var config = module.exports = {
    ...
    styles: '' +
        ...
        '#PPMiniCart .minicart-item { position: relative; height: 30px; padding: 6px; border-top: 1px solid #f2f2f2; }' +
        '#PPMiniCart .minicart-item a { position: absolute; top: 6px; left: 0; width: 185px; text-decoration: none; }' +
        '#PPMiniCart .minicart-quantity { position: absolute; left: 190px; width: 30px; }' +
        '#PPMiniCart .minicart-remove { position: absolute; top: 10px; left: 230px; width: 14px; height: 14px; background: url(http://www.minicartjs.com/build/images/minicart_sprite.png) no-repeat -134px -4px; border: 0; cursor: pointer; }' +
