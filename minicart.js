...
(function () {
    ...
    var config = {      
         ...
         */     
        assetURL: 'https://minicart.paypal-labs.com/',
    ...
    PAYPAL.apps.MiniCart = (function () {
        ...
        var _init = function (userConfig) {
            ...
            // Process any stored data and update the UI
        ...
        var _dataFilter = function (raw) {
            var data = {}, 
                ...
                settingFilter = /^(?:business|currency_code|lc|paymentaction|no_shipping|cn|no_note|invoice|handling_cart|weight_cart|weight_unit|tax_cart|page_style|image_url|cpp_|cs|cbt|return|cancel_return|notify_url|rm|custom)/,
                length = raw.length,
                pair,
                value,
                existing,
